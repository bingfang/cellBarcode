...
```{r}
# MCEMP1
sum(pi.all.g["ENSG00000183019",])
g.on.all.g["ENSG00000183019"]
g.off.all.g["ENSG00000183019"]
a.all.g["ENSG00000183019"]
sigma.all.g["ENSG00000183019",]+mu.g


#MSR1
sum(pi.all.g["ENSG00000038945",])
g.on.all.g["ENSG00000038945"]
g.off.all.g["ENSG00000038945"]
a.all.g["ENSG00000038945"]
sigma.all.g["ENSG00000038945",]+mu.g

id <- c("ENSG00000038945","ENSG00000170323","ENSG00000183019","ENSG00000102575","ENSG00000131471","ENSG00000139329","ENSG00000136546","ENSG00000077943","ENSG00000131097","ENSG00000171303","ENSG00000172137","ENSG00000116690","ENSG00000243566","ENSG00000204305","ENSG00000182010")
sym<-c('MSR1', 'FABP4','MCEMP1', 'ACP5','AOC3', 'LUM', 'SCN7A', 'ITGA8', 'HIGD1B', 'KCNK3', 'CALB2', 'PRG4', 'UPK3B' ,'AGER','RTKN2')
for(i in 1:15){
  cat(id[i],sym[i],"probability of null and off states")
 
  print(sum(pi.all.g[id[i],]))
}

```

10 out of 15 marker genes are considered as always-off genes.
...
# merge
geneList<-merge(marker_gene,gene_Ensemble, by.x = "symbol", by.y = "gene_name", all.x = TRUE) 


gencode[gencode$gene_name == "ACP5",]





"AGER" %in% cellRef$RNA@meta.features$origSymbol
"RTKN2" %in% cellRef$RNA@meta.features$origSymbol

"ENSG00000204305" %in% cellRef$RNA@data@Dimnames[[1]]  
"ENSG00000182010" %in% cellRef$RNA@data@Dimnames[[1]]  
head(cellRef$RNA@data@Dimnames[[1]] )
...
id <- c("ENSG00000038945","ENSG00000170323", "ENSG00000183019","ENSG00000102575","ENSG00000131471","ENSG00000139329","ENSG00000136546","ENSG00000077943","ENSG00000131097","ENSG00000171303" )
...
# Mesothelium'['CALB2',ENSG00000172137 'PRG4',ENSG00000116690]	['CALB2', 'UPK3B' ENSG00000243566]
# AT1 ['AGER'ENSG00000204305]	['RTKN2',ENSG00000182010]
id <- c("ENSG00000038945","ENSG00000170323", "ENSG00000183019","ENSG00000102575","ENSG00000131471","ENSG00000139329","ENSG00000136546","ENSG00000077943","ENSG00000131097","ENSG00000171303","ENSG00000172137","ENSG00000116690","ENSG00000243566","ENSG00000204305","ENSG00000182010")

## markers
marker<-c('Alveolar macrophage_HLCA_marker', 'Alveolar macrophage_HLCA_marker','Alveolar macrophage_cellRef_marker', 'Alveolar macrophage_cellRef_marker','Alveolar fibroblast 2_HLCA_marker', 'Alveolar fibroblast 2_HLCA_marker','Alveolar fibroblast 2_cellRef_marker', 'Alveolar fibroblast 2_cellRef_marker','Pericyte_marker', 'Pericyte_marker', 'Mesothelium_marker', 'Mesothelium_HLCA_marker', 'Mesothelial cell_cellRef_marker', 'AT1_HLCA_marker','Alveolar type 1 cell_cellRef_marker')
sym<-c('MSR1', 'FABP4','MCEMP1', 'ACP5','AOC3', 'LUM', 'SCN7A', 'ITGA8', 'HIGD1B', 'KCNK3', 'CALB2', 'PRG4', 'UPK3B' ,'AGER','RTKN2')
id <- c("ENSG00000038945","ENSG00000170323", "ENSG00000183019","ENSG00000102575","ENSG00000131471","ENSG00000139329","ENSG00000136546","ENSG00000077943","ENSG00000131097","ENSG00000171303","ENSG00000172137","ENSG00000116690", "ENSG00000243566","ENSG00000204305","ENSG00000182010")


## run 5 cell-type in HLCA
seurat_dataset<-hlca
dataset_name <-"hlca"
cell_type_list <- c("Alveolar macrophages","Alveolar fibroblasts", "AT1", "Pericytes", "Mesothelium" )
...
cell_type_list <- c("Alveolar macrophage","Alveolar fibroblast 2","Alveolar type 1 cell","Pericyte", "Mesothelial cell")
cut_off_list <- c(0.75,0.95)
